...
A `LICENSE-hyperdx` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [hyperdxio/hyperdx](https://github.com/hyperdxio/hyperdx), Copyright
2023 DeploySentinel, Inc, licensed under MIT. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../hyperdx-port/specs/SPEC-001-hyperdx.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
